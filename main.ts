...
async function selectDepartment(): Promise<Department> {
...
async function selectCourse(department: Department): Promise<Course> {
...
async function selectInstructor(): Promise<Instructor> {
